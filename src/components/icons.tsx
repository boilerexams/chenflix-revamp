export function CourseCard({courseAbbreviation, courseName, courseDescr, semesterList, semesterLinks}: 
	...
	return (
		<div style={{ paddingTop: '2vh' }}>
			...
			>
				<div
					className="relative flex aspect-[2.5/2] select-none flex-col items-center justify-center gap-5 rounded-3xl text-center font-bold text-white opacity-100 transition-all duration-300 group-hover:opacity-0 px-5"
				>
					<div
					...
					></div>
					<h1 className="z-10 text-5xl">{courseName}</h1>
