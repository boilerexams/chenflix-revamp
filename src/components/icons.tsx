	...
	return (
		<div style={{ paddingTop: '2vh' }}>
			...
			>
				{/* px-5 ? */}
				<div
					className="relative flex aspect-[2.5/2] select-none flex-col items-center justify-center gap-5 rounded-3xl text-center font-bold text-white opacity-100 transition-all duration-300 group-hover:opacity-0"
				>
					<div
